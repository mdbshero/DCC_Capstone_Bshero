    ...
    <div>
      <div>
        ...
        >
          ...
          <input type="text" onChange={(event) => setEm(event.target.value)} />
          <br />
          <label>Do you currently own, rent, or lease:</label>
          <input type="text" onChange={(event) => setHS(event.target.value)} />
          <br />
          <label>How long have you lived at your current residence?</label>
          <input type="text" onChange={(event) => setHT(event.target.value)} />
          <br />
          <label>The noise/activity in my home is usually:</label>
          <input type="text" onChange={(event) => setHN(event.target.value)} />
          <br />
          <label>Name of Landlord if applicable:</label>
          <input type="text" onChange={(event) => setLN(event.target.value)} />
          <br />
          <label>Number of Landlord if applicable:</label>
          <input type="text" onChange={(event) => setLNu(event.target.value)} />
          <br />
          ...
          <input type="text" onChange={(event) => setAR(event.target.value)} />
          <br />
          <label>How long will the dog be left alone each day?:</label>
          <input type="text" onChange={(event) => setPH(event.target.value)} />
          <br />
          <label>Where will the dog be kept when no one is home?:</label>
          <input type="text" onChange={(event) => setPL(event.target.value)} />
          <br />
          <label>Where will the dog be kept at night?:</label>
          <input type="text" onChange={(event) => setPS(event.target.value)} />
          <br />
          ...
          <input type="text" onChange={(event) => setVN(event.target.value)} />
          <br />
          ...
          <input type="text" onChange={(event) => setPD(event.target.value)} />
          <br />
          <label>
            Please describe what activity level you would like in a pet:
          </label>
          <input type="text" onChange={(event) => setPE(event.target.value)} />
          <br />
          <label>Please describe what you would like in a pet:</label>
          <input type="text" onChange={(event) => setPI(event.target.value)} />
          <br />
          <label>
            Please describe what bad habits you would not be able to tolerate in
            a pet:
          </label>
          <input type="text" onChange={(event) => setPB(event.target.value)} />
          <br />
          <label>
            ...
            animal as is, assume all risks and responsibilities associated with
            the ownership of the Animal, including bites, and I hereby fully and
            completely release, indemnify and hold harmless Rescue A Dog, Inc.,
            its directors, officers, volunteers, servants, and employees from
            any claim, cause of action or liability of any sort or nature,
            whether known or unknown, directly or indirectly arising out of or
            in connection with the adoption, care or ownership, maintenance,
            temperament or condition of the Animal. Please Initial
          </label>
          <input
            type="text"
          ...
          <br />
          <label>
            I agree in the case I cannot keep the animal, they will be returned
            to their respective adoptive agency. All monies deposited will be
            considered a donation to the rescue and are non-refundable. Please
            Initial
          </label>
          <input
            type="text"
          ...
          <label>
            ...
            denied adoption of an animal or if animal has been adopted to me,
            the return of that animal to the respective adoption agency. I
            certify that the above information is true and correct to the best
            of my knowledge. Please Initial
          </label>
          <input
            type="text"
